...
/*
 * THANKS DAVE MOD FOR BEING OPEN-SOURCED!!!
*/

class MusicShit extends MusicBeatState
{
    ...
    override function create()
    {
        ...
        bg = new FlxSprite().loadGraphic(Paths.image('menuBGMusic'));
		add(bg);
        ...
        healthBarBG = new FlxSprite(0, 50).loadGraphic(Paths.image('healthBar', 'shared'));
